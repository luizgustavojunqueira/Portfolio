...
export default function Home({ lang, theme }: IHome) {
  return (
    <>
      ...
      >
        <h1 className="flex flex-col text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold items-center justify-center text-center mb-10 md:mb-20 text-black dark:text-white">
          <span>Luiz</span>
          <span>Gustavo</span>
        </h1>
