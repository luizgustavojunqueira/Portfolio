...
export default function Home({ lang }: { lang: "en" | "pt" }) {
    ...
    return (
        <>
            <section
                id="home"
                className="transition-colors flex flex-col items-center justify-center md:grid md:grid-cols-2 gap-4 h-screen bg-slate-200 dark:bg-midgray text-black dark:text-white"
            >
