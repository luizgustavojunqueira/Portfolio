        ...
        <section id="contact" className="page flex-start column">
            ...
            <section className="flex-center column content-container ">
                <section className="flex-center">
                    <h3 className="highlight-text-dark large">Get in touch</h3>
                </section>

                <section className="grid-two contact ">
                    <section className="flex-center column ">
                        <section className="flex-start column contact-item form">
                            <section className="medium highlight-text-dark ">
                                <h4> Send me an e-mail </h4>
                            </section>
                            <section className="flex-center column width-100">
                                <input
                                    className="small"
                                    type="text"
                    ...
                    <section className="flex-center column ">
                        <section className="flex-start column contact-item">
                            ...
                            <section className="flex-center column contact-icons">
                                <span>
                                    <a
