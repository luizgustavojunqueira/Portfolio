...
function Interests({ interests, label }: IInterests) {
  ...
  return (
    <section className="w-full">
      ...
      <div className="flex flex-col md:flex-row md:h-85 lg:h-70 border border-slate-100 dark:border-slate-900 overflow-hidden">
          ...
          return (
            <div
              ...
              className={`relative overflow-hidden flex transition-[flex-grow,height] duration-200 ease-in-out
                    ${isOpen ? "h-fit md:h-full md:flex-[3_1_0%] bg-black dark:bg-white flex-row-reverse" : "h-13 md:h-full md:flex-[0_0_52px] min-w-13 bg-white dark:bg-black"}
